 ...
 */
package org.codelabor.example.crud.emp.web.controller;
...
import org.codelabor.example.crud.emp.dto.EmpSearchConditionDto;
import org.codelabor.example.crud.emp.service.DeptService;
import org.codelabor.example.crud.emp.service.EmpService;
 ...
 */
@Controller
@RequestMapping("/example/crud/emp")
public class EmpController { // NOPMD by "SHIN Sang-jae"

	private final Logger logger = LoggerFactory.getLogger(EmpController.class);

	private static final String CREATE_VIEW_NAME = "example/crud/emp/create";
	private static final String UPDATE_VIEW_NAME = "example/crud/emp/update";
	private static final String LIST_VIEW_NAME = "example/crud/emp/list";
	private static final String LIST_URL = "/example/crud/emp/listEmp";
	private static final String READ_VIEW_NAME = "example/crud/emp/read";
	private static final String READ_URL = "/example/crud/emp/readEmp";
	...
	// servlet 2.5
	private List<EmpDto> fileToDtoList(MultipartFile file, List<String> failureMessages) throws IllegalArgumentException, InvalidFormatException, IOException { // NOPMD
																																								// by
																																								// "SHIN Sang-jae"
	...
	// servlet 3.0
	private List<EmpDto> fileToDtoList(Part file, List<String> failureMessages) throws IllegalArgumentException, InvalidFormatException, IOException { // NOPMD
																																						// by
																																						// "SHIN Sang-jae"
	...
	public ModelAndView listEmp(@Valid EmpSearchConditionDto empSearchConditionDto, BindingResult result, HttpServletRequest request,
			@ModelAttribute("successMessages") ArrayList<String> successMessages, RedirectAttributes redirectAttributes, Locale locale) { // NOPMD by
																																			// "SHIN Sang-jae"
		...
		if (result.hasErrors()) {
			...
			if (empDtoList == null) {
				empDtoList = Collections.emptyList();
			}
