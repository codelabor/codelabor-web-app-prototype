...
<head>
<meta charset="UTF-8" />
<title><spring:message code="title.example.crud.emp.create" /> <system:properties key="servlet.container.id" /></title>
...
<body class="composite">
	...
	<div id="bodyColumn">
		<div id="contentBox">
			<div class="section">
				<h2>
					<spring:message code="heading.emp.create" />
				</h2>
				<hr />
				<form:form commandName="empDto">
					...
					<hr />
					<a href="${pageContext.request.contextPath}/example/crud/emp/listEmp"><spring:message code="button.list" /></a>
