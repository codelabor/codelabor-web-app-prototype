...
<head>
<meta charset="UTF-8" />
<title><spring:message code="title.example.crud.emp.read" /> <system:properties key="servlet.container.id" /></title>
...
<body class="composite">
	...
	<div id="bodyColumn">
		...
		-->
				...
				<hr />
				<a href="${pageContext.request.contextPath}/example/crud/emp/listEmp"><spring:message code="button.list" /></a> <a
					href="${pageContext.request.contextPath}/example/crud/emp/updateEmp?empNo=<c:out value="${empDto.empNo}" />"><spring:message code="button.update" /></a>
			</div>
		</div>
	</div>
	<div class="clear">
