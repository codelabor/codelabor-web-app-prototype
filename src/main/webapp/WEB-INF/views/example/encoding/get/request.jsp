...
<body class="composite">
	...
	<div id="bodyColumn">
		<div id="contentBox">
			<div class="section">
				<h2>Encoding Get Example</h2>
				<h3>Get</h3>
				<ul>
					<li><a href="${pageContext.request.contextPath}/example/encoding/get/result?param1=1234&param2=abcd&param3=가나다라마바사">get example</a></li>
				</ul>
			</div>
		</div>
	</div>
