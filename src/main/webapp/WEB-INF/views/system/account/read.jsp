			...
			<div class="section">
				...
				<table class="bodyTable">
					<tr class="b">
						...
						<td><span id="username"><c:out value="${userDetails.username}" /></span></td>
					</tr>
					<tr class="b">
						<th><label for="password"><spring:message code="label.account.password" /></label></th>
						<td><span id="password"><c:out value="${userDetails.password}" /></td>
					</tr>
					<tr class="b">
				...
				<a href="${pageContext.request.contextPath}/system/account/listAccount"><spring:message code="button.list" /></a> <a
					href="${pageContext.request.contextPath}/system/account/updateAccount?username=<c:out value="${userDetails.username}" />"><spring:message code="button.update" /></a>
