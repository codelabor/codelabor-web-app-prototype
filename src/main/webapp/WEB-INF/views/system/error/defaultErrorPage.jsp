...
<body class="composite">
	...
	<div id="bodyColumn">
		<div id="contentBox">
			<div class="section">
				<h1>
					<spring:message code="heading.error.http.status.code.500" />
				</h1>

				<p>
					<spring:message code="errors.http.status.code.500.with.requestId" arguments="${requestId}" htmlEscape="false" />
				</p>
				<p>
